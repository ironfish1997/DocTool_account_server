...
import top.liuliyong.sso_server.annotation.SsoServer;
import top.liuliyong.sso_server.config.SSOConf;
import top.liuliyong.sso_server.core.login.SsoTokenLoginHelper;
import top.liuliyong.sso_server.core.result.ReturnT;
import top.liuliyong.sso_server.core.store.SsoSessionIdHelper;
import top.liuliyong.sso_server.service.UserService;
...
public class SSOAppController {
     ...
     * @return
     */
    @RequestMapping(value = SSOConf.SSO_LOGIN, method = RequestMethod.POST)
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = SSOConf.SSO_LOGOUT, method = RequestMethod.POST)
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = SSOConf.SSO_LOGINCHECK, method = RequestMethod.POST)
    @ResponseBody
